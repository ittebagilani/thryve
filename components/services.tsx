...
const ServicesSection = () => {
  return (
    <section id="services" className="py-24 px-6 bg-slate-950 text-slate-700">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            We offer a comprehensive range of marketing services to help your business grow and succeed.
          </motion.p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-rose-500 transition-colors duration-300">{service.title}</h3>
